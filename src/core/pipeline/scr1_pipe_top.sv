...
logic [`SCR1_XLEN-1:0]                      bp_lookup_target;
logic [`SCR1_XLEN-1:0]                      bp_lookup_pc;
logic                                       bp_train_valid;
logic                                       bp_train_taken;
logic [`SCR1_XLEN-1:0]                      bp_train_pc;
logic [`SCR1_XLEN-1:0]                      bp_train_target;
logic                                       bp_invalidate;
...
logic                                       ifu2idu_pred_taken;
logic [`SCR1_XLEN-1:0]                      ifu2idu_pred_target;
...
//-------------------------------------------------------------------------------
scr1_branch_predictor i_branch_predictor (
    .clk                    (clk                ),
    .rst_n                  (pipe_rst_n         ),
    .invalidate_i           (bp_invalidate      ),
    .lookup_pc_i            (bp_lookup_pc       ),
    .predict_taken_o        (bp_lookup_taken    ),
    .predict_target_o       (bp_lookup_target   ),
    .train_valid_i          (bp_train_valid     ),
    .train_taken_i          (bp_train_taken     ),
    .train_pc_i             (bp_train_pc        ),
    .train_target_i         (bp_train_target    )
);
...
scr1_pipe_ifu i_pipe_ifu (
    ...
    .bp_predict_taken_i       (bp_lookup_taken    ),
    .bp_predict_target_i      (bp_lookup_target   ),
    .ifu2bp_lookup_pc_o       (bp_lookup_pc       ),
...
`endif // SCR1_CLKCTRL_EN
    ...
    .ifu2idu_pred_taken_o     (ifu2idu_pred_taken ),
    .ifu2idu_pred_target_o    (ifu2idu_pred_target),
...
`endif // SCR1_CLKCTRL_EN
    ...
    .idu2exu_branch_predicted_i     (ifu2idu_pred_taken      ),
    .idu2exu_branch_pred_target_i  (ifu2idu_pred_target     ),
...
`endif // SCR1_CLKCTRL_EN
    ...
    .exu2bp_branch_valid_o          (bp_train_valid          ),
    .exu2bp_branch_taken_o          (bp_train_taken          ),
    .exu2bp_branch_pc_o             (bp_train_pc             ),
    .exu2bp_branch_target_o         (bp_train_target         ),
    .exu2bp_invalidate_o            (bp_invalidate           )
);
